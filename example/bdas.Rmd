...
After starting the BDA you can add as many rulesets for the BDA as you like.For this, the method add_bda is used.
Its first and second argument determine which part of the codons is assessed in the BDA, the following four refer to which bases are used for the BDA. For a clearer insight, refer to the github [page](https://github.com/StarmanMartin/GCATR#add_bda).
